runPCountAllyearsNetworkWideSpecies<-function(DataIn, modSel, networkName,speciesIn=NA,nGOF){
  ...
  for(i in 1:length(habitatList)){
    ...
    new.data<-subset(data, Survey_Type==habitatType)
      ...
      print(unitName)
        ...
        #get speciesList
      if(is.na(speciesIn)){
        speciesList<-unique(new.data$AOU_Code)
      } else {
        ...
        print(speciesName)
          ...
          #mod1.gof
          print("Mod1-GOF")
          mod1.gof<- try(Nmix.gof.test(mod1, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
          ...
          #mod2.gof
          print("Mod2-GOF")
          mod2.gof<- try(Nmix.gof.test(mod2, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
          ...
          #mod3.gof
          print("Mod3-GOF")
          mod3.gof<- try(Nmix.gof.test(mod3, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
          ...
          #mod4.gof
          print("Mod4-GOF")
          mod4.gof<- try(Nmix.gof.test(mod4, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
          ...
          #mod5.gof
          print("Mod5-GOF")
          mod5.gof<- try(Nmix.gof.test(mod5, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
          ...
          #mod6.gof
          print("Mod6-GOF")
          mod6.gof<- try(Nmix.gof.test(mod6, nsim = nGOF, plot.hist = FALSE,report = NULL, parallel = FALSE))
