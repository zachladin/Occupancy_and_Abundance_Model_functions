...
mb.chisq.unmarkedFitOccu <- function(mod, print.table = TRUE, ...) {
  ...
  if(na.vals) {
    ...
    #ZL-edited line (convert det.hist.na$det.hist to factor)
    out.hist.na$det.hist<-as.factor(out.hist.na$det.hist)
    out.hist.na$det.hist <- droplevels(out.hist.na$det.hist)
    ...
    #ZL-edited lines to convert string to factors
    out.hist.not.na$det.hist<-as.factor(out.hist.not.na$det.hist)
    out.hist.not.na$det.hist <- droplevels(out.hist.not.na$det.hist)
